...
SELECT CASE WHEN OBJECT_ID('dbo.spRefreshSemuaStok') IS NULL
            THEN 'BELUM ADA — jalankan satukan_sumber_angka.sql'
            ELSE 'SUDAH ADA' END AS status;

SELECT TOP 5 nId, cNoSc, dTanggal, nQtyPc, cJenis, lVoid, UserId
