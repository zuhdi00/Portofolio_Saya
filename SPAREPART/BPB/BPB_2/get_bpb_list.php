...
try {
    ...
    // Keyword 1 - specific search (No BPB, Kode Bahan, No OPB)
    ...
    // Keyword 2 - specific search (Supplier, Nama Barang, Keterangan)
    ...
    // Debug info (hanya untuk development, hapus di production)
    $debugInfo = [
        'total_conditions' => count($whereConditions),
        'total_parameters' => count($parameters),
        'conditions' => $whereConditions,
        'has_keyword1' => !empty($searchParams['keyword1']),
        'has_keyword2' => !empty($searchParams['keyword2']),
        'has_search' => !empty($searchParams['search'])
    ];
