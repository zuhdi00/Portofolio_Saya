...
// Hitung total nQtyStok untuk OP yang sama di tbStbBJ
...
$maxQty = $nQtyOrder + ($nToleransi * $nQtyOrder);
...
$fields = [
    ...
    'lVoid', 'cCom', 'cType', 'nBerat', 'nBerat2', 'cSub1', 'cSub2', 'cSub3', 'cSub4', 'cSub5',
...
if ($row = sqlsrv_fetch_array($stmt, SQLSRV_FETCH_ASSOC)) {
    ...
    foreach ($fields as $f) {
            if ($f === 'cType') {
                ...
                // gunakan nilai yang dikirim melalui POST jika tersedia, bila tidak pakai nilai dari tbTmpStbBJ
                $insertParams[] = $nBerat2 !== null ? $nBerat2 : ($row[$f] ?? null);
            } else {
