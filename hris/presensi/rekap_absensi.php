<?php
/**
 * presensi/rekap_absensi.php
 * Rekap kehadiran dari dbo.absensi + filter tanggal / departemen / shift / status.
 * Untuk HR: lihat, saring, dan ekspor kehadiran seluruh karyawan.
 */
...
if ($status_kary !== '') { $where[] = "p.status_karyawan = ?"; $params[] = $status_kary; }
