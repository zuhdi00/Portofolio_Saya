...
$KLASIFIKASI = [
    'VOLUNTARY'        => 'Voluntary (kemauan sendiri)',
    'INVOLUNTARY'      => 'Involuntary (diberhentikan)',
    'RETIREMENT'       => 'Retirement (pensiun)',
    'CONTRACT_END'     => 'Contract End (kontrak habis)',
    'MUTUAL_AGREEMENT' => 'Mutual Agreement (kesepakatan)',
    'ABSCOND'          => 'Abscond (mangkir)',
    'LAINNYA'          => 'Lainnya',
];
