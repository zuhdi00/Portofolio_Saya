...
// tanggal surat = tgl_mulai (pengajuan), fallback hari ini
$tglSurat = $f['tgl_mulai'] instanceof DateTime ? $f['tgl_mulai'] : new DateTime();
$b=['','Januari','Februari','Maret','April','Mei','Juni','Juli','Agustus','September','Oktober','November','Desember'];
...
<style>
  *{box-sizing:border-box;margin:0;padding:0}
  ...
  .ttd-atas{display:flex;justify-content:space-between;margin-bottom:60px}
  .ttd-bawah{display:flex;justify-content:space-between}
  .kolom{width:32%;text-align:center;line-height:1.5}
...
<div class="kertas" style="margin-top:60px">
  ...
  <div class="isi">
    ...
    <p>Menyatakan dengan sesungguhnya bahwa mulai tanggal <strong><?= tglIndo($f['tgl_berakhir']) ?></strong>
  ...
  <div class="ttd-wrap">
    ...
    <div class="ttd-atas">
      ...
      <div class="kolom">Diketahui oleh,</div>
    </div>
    <div class="ttd-bawah">
      <div class="kolom">
