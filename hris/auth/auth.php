...
$HAK_AKSES = [
    ...
    'hr'           => ['dashboard','pegawai_lihat','pegawai_edit','absensi_rekap',
                       'koreksi_approval','lembur_input','lembur_rekap','modul_hr','resign_input','lupa_absen_input','resign_nilai'],
    'atasan'       => ['dashboard','pegawai_lihat','absensi_rekap',
                       'koreksi_approval','lembur_input','resign_input','lupa_absen_input','resign_nilai'],
    'admin_divisi' => ['dashboard','pegawai_lihat','absensi_rekap','lembur_input','resign_input','lupa_absen_input'],
    'user'         => ['dashboard','absensi_sendiri','resign_input','lupa_absen_input'],
];
