...
--
-- Host: localhost:3306
-- Generation Time: Jan 28, 2025 at 10:41 AM
...
(2123026, '1111-11-11', '2222-02-22', 'Aktif', '1000000', 1),
(83125, '2006-04-08', '2006-08-04', 'Aktif', '4444444', 1),
(46464646, '9999-09-09', '7777-08-09', 'Aktif', '123456789', 1),
(212121, '3005-03-03', '4006-04-04', 'Aktif', '1019181716', 1);
...
CREATE TABLE `riwayat perubahan kontrak` (
  ...
  `gaji_sebelum_perubahan` varchar(11) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `gaji_setelah_perubahan` varchar(50) COLLATE utf8mb4_general_ci NOT NULL,
  `keterangan_perubahan` varchar(50) COLLATE utf8mb4_general_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Dumping data for table `riwayat perubahan kontrak`
--
...
(11, 11111, '2025-11-11', '10,000', '100.000.000', 'direktur');
