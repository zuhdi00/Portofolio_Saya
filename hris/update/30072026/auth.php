...
$HAK_AKSES = [
    ...
    'hr'           => ['dashboard','pegawai_lihat','pegawai_edit','absensi_rekap',
                       'koreksi_approval','lembur_input','lembur_rekap'],
    'atasan'       => ['dashboard','pegawai_lihat','absensi_rekap',
                       'koreksi_approval','lembur_input'],
    'admin_divisi' => ['dashboard','pegawai_lihat','absensi_rekap','lembur_input'],
    'user'         => ['dashboard','absensi_sendiri'],
];
