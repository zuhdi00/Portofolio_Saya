...
<aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
        ...
        <li class="nav-item">
            <a class="nav-link collapsed" href="<?php echo BASE_URL; ?>/hris/lupa_absen/input.php">
                <i class="bi bi-calendar-x"></i><span>Input Lupa Absen</span></a>
        </li>
        <?php endif; ?>
        <?php if (boleh('modul_hr')): ?>
        <li class="nav-item">
            <a class="nav-link collapsed" href="<?php echo BASE_URL; ?>/hris/lupa_absen/approval_hr.php">
                <i class="bi bi-calendar-check"></i><span>Approval Lupa Absen</span></a>
        </li>
        <?php endif; ?>
        ...
        <li class="nav-item">
            <a class="nav-link collapsed" href="<?php echo BASE_URL; ?>/hris/pengunduran_diri/index.php">
                <i class="bi bi-box-arrow-right"></i><span>Pengunduran Diri</span></a>
        </li>
        <li class="nav-item">
            <a class="nav-link collapsed" href="<?php echo BASE_URL; ?>/hris/pengunduran_diri/daftar_penilaian.php">
                <i class="bi bi-clipboard-data"></i><span>Penilaian Resign</span></a>
        </li>
        <li class="nav-item">
            <a class="nav-link collapsed" href="<?php echo BASE_URL; ?>/hris/pengunduran_diri/kelola_klasifikasi.php">
                <i class="bi bi-tags"></i><span>Klasifikasi Resign</span></a>
        </li>
        <?php endif; ?>
