...
<style>
  *{box-sizing:border-box;margin:0;padding:0}
  ...
  .kop{display:flex;align-items:center;border-bottom:3px double #000;padding-bottom:12px;margin-bottom:6px}
  ...
  .ttd .kotak{width:250px;text-align:center;font-size:13px}
...
<div class="kertas" style="margin-top:60px">
  <div class="kop">
    <div>
      <div class="nama">PT SUPRACOR SEJAHTERA</div>
      <div class="alamat">Corrugated Box Manufacturer</div>
    </div>
  </div>
  ...
  <div class="ttd">
    <div class="kotak">
      <?= h($f['nama_dept'] ?? '') ?>, <?= tglIndo($f['tanggal']) ?><br>
