    ...
    <ul class="sidebar-nav" id="sidebar-nav">
        ...
        <li class="nav-item">
            <a class="nav-link collapsed" data-bs-target="#absensi-nav" data-bs-toggle="collapse" href="#">
                <i class="bi bi-fingerprint"></i><span>Presensi &amp; Absensi</span><i class="bi bi-chevron-down ms-auto"></i>
            </a>
        ...
        <li class="nav-item">
            <a class="nav-link collapsed" data-bs-target="#lembur-nav" data-bs-toggle="collapse" href="#">
                <i class="bi bi-clock-history"></i><span>Lembur</span><i class="bi bi-chevron-down ms-auto"></i>
            </a>
            <ul id="lembur-nav" class="nav-content collapse" data-bs-parent="#sidebar-nav">
                <li>
                    <a href="<?php echo BASE_URL; ?>/hris/lembur/pengajuan.php">
                        <i class="bi bi-pencil-square"></i><span>Pengajuan Lembur</span></a>
                </li>
                <li>
                    <a href="<?php echo BASE_URL; ?>/hris/lembur/approval.php?peran=atasan">
                        <i class="bi bi-person-check"></i><span>Approval Atasan</span></a>
                </li>
                <li>
                    <a href="<?php echo BASE_URL; ?>/hris/lembur/approval.php?peran=hr">
                        <i class="bi bi-shield-check"></i><span>Approval HR</span></a>
                </li>
            </ul>
