...
<aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
        ...
        <!-- ============ LEMBUR ============ -->
        <li class="nav-item">
            <a class="nav-link collapsed" href="<?php echo BASE_URL; ?>/hris/lembur/pengajuan.php">
                <i class="bi bi-clock-history"></i><span>Pengajuan Lembur</span>
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link collapsed" href="<?php echo BASE_URL; ?>/hris/lembur/approval.php?peran=atasan">
                <i class="bi bi-person-check"></i><span>Lembur: Approval Atasan</span>
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link collapsed" href="<?php echo BASE_URL; ?>/hris/lembur/approval.php?peran=hr">
                <i class="bi bi-shield-check"></i><span>Lembur: Approval HR</span>
            </a>
