<?php
/**
 * pegawai/edit.php  [dbHR / SQL Server]
 * Form edit pegawai - struktur identik dengan tambah_pegawai_lengkap.php,
 * tapi semua field terisi dari database. Termasuk keluarga, pendidikan, pengalaman.
 * Submit ke update_pegawai_lengkap.php
 */
...
$KAWIN = ['SINGLE','MARRIED','DIVORCED','WIDOWED'];
            ...
            <fieldset>
                <div class="row g-3">
                    <div class="col-md-3"><label class="form-label">Company Name :</label>
                        <input type="text" name="company_name" class="form-control" value="<?= val($p['company_name'] ?: 'GRP1') ?>"></div>
                    <div class="col-md-3"><label class="form-label">NIK :</label>
                        <input type="text" name="nik" class="form-control" value="<?= val($p['nik']) ?>"></div>
                    <div class="col-md-6"><label class="form-label">Nama Pegawai :</label>
                        <input type="text" name="nama" class="form-control text-uppercase" value="<?= val($p['nama_peg']) ?>" required></div>
                </div>
            </fieldset>
            ...
            <fieldset>
                ...
                <div class="row g-3">
                    <div class="col-md-3"><label class="form-label">Enterprise Begin :</label>
                        <input type="date" name="enterprise_begin" class="form-control" value="<?= dtv($p['tgl_masuk']) ?>"></div>
                    <div class="col-md-3"><label class="form-label">Enterprise End :</label>
                        <input type="date" name="enterprise_end" class="form-control" value="<?= dtv($p['tgl_akhir_kontrak'] ?? null) ?>"></div>
                    <div class="col-md-3"><label class="form-label">Termination Effective :</label>
                        <input type="date" name="termination_effective" class="form-control" value="<?= dtv($p['tgl_berhenti'] ?? null) ?>"></div>
                    <div class="col-md-3"><label class="form-label">Contract (Month) :</label>
                        <input type="number" name="contract_month" class="form-control" value="<?= val($p['contract_month']) ?>"></div>
                    <div class="col-md-6"><label class="form-label">Term Reason :</label>
                        <input type="text" name="term_reason" class="form-control" value="<?= val($p['alasan_berhenti'] ?? '') ?>"></div>
                    <div class="col-md-3"><label class="form-label">Personnel Area :</label>
                        <input type="text" name="personnel_area" class="form-control" value="PT Supracor Sejahtera"></div>
                    <div class="col-md-3"><label class="form-label">Personnel Sub Area :</label>
                        <input type="text" name="personnel_subarea" class="form-control"></div>
                    <div class="col-md-4"><label class="form-label">Job Title :</label>
                        <select name="job_title" class="form-select"><?= opts($JABATAN, $p['position_code'] ?? '') ?></select></div>
                    <div class="col-md-8"><label class="form-label">Unit :</label>
                        <input type="text" name="unit_kerja" class="form-control" value="<?= val($p['lokasi_kerja'] ?? '') ?>"></div>
                    <div class="col-md-3"><label class="form-label">Position :</label>
                        <input type="text" name="position_code" class="form-control" value="<?= val($p['position_code']) ?>"></div>
                    <div class="col-md-3"><label class="form-label">Work Location :</label>
                        <input type="text" name="work_location" class="form-control" value="<?= val($p['work_location'] ?? '') ?>"></div>
                    <div class="col-md-2"><label class="form-label">Level :</label>
                        <select name="level_code" class="form-select"><?= opts($LEVEL, $p['level_code']) ?></select></div>
                    <div class="col-md-2" style="display:none"><label class="form-label">Grade :</label>
                        <input type="text" name="grade_code" class="form-control" value="<?= val($p['grade_code']) ?>"></div>
                    <div class="col-md-4"><label class="form-label">Employee Subgroup :</label>
                        <select name="employee_subgroup" class="form-select"><?= opts($SUBGROUP, $p['employee_subgroup']) ?></select></div>
                </div>
            </fieldset>
            ...
            <fieldset>
                ...
                <div class="row g-3">
                    <div class="col-md-4"><label class="form-label">Birth Place :</label>
                        <input type="text" name="tempat_lahir" class="form-control" value="<?= val($p['tempat_lahir']) ?>"></div>
                    <div class="col-md-3"><label class="form-label">Birth Date :</label>
                        <input type="date" name="tanggal_lahir" class="form-control" value="<?= dtv($p['tgl_lahir']) ?>"></div>
                    <div class="col-md-3"><label class="form-label">Religion :</label>
                        <select name="agama" class="form-select"><?= opts($AGAMA, $p['agama']) ?></select></div>
                    <div class="col-md-2"><label class="form-label">Gender :</label>
                        <select name="gender" class="form-select">
                            <option value="">--</option>
                            <option value="M"<?= $p['gender']==='L'?' selected':'' ?>>M (Laki-laki)</option>
                            <option value="F"<?= $p['gender']==='P'?' selected':'' ?>>F (Perempuan)</option>
                        </select></div>
                    <div class="col-md-4"><label class="form-label">NPWP Number :</label>
                        <input type="text" name="npwp" class="form-control" value="<?= val($p['npwp']) ?>"></div>
                    <div class="col-md-4"><label class="form-label">ID Number (KTP) :</label>
                        <input type="text" name="no_ktp" class="form-control" maxlength="16" value="<?= val($p['no_ktp']) ?>"></div>
                    <div class="col-md-4"><label class="form-label">Marital Status :</label>
                        <select name="status_kawin" class="form-select"><?= opts($KAWIN, $p['status_kawin'] ?? '') ?></select></div>
                    <div class="col-md-6"><label class="form-label">Email Address :</label>
                        <input type="email" name="email" class="form-control" value="<?= val($p['email_peg']) ?>"></div>
                    <div class="col-md-6"><label class="form-label">PTKP Status :</label>
                        <select name="ptkp_status" class="form-select"><?= opts($PTKP, rev('pegawai.status_nikah', $p['status_nikah'])) ?></select></div>
                </div>
                ...
                <div class="sub-box mt-4"><span class="box-title">Permanent Address</span>
                    <div class="row g-3">
                        <div class="col-md-8"><label class="form-label">Address :</label>
                            <textarea name="almt_tetap" class="form-control" rows="2"><?= val($p['alamat_ktp_peg']) ?></textarea></div>
                        <div class="col-md-2"><label class="form-label">RT :</label>
                            <input type="text" name="almt_tetap_rt" class="form-control" value="<?= val($p['rt']) ?>"></div>
                        <div class="col-md-2"><label class="form-label">RW :</label>
                            <input type="text" name="almt_tetap_rw" class="form-control" value="<?= val($p['rw']) ?>"></div>
                        <div class="col-md-3"><label class="form-label">Village :</label>
                            <input type="text" name="almt_tetap_desa" class="form-control" value="<?= val($p['kelurahan']) ?>"></div>
                        <div class="col-md-3"><label class="form-label">Sub-District :</label>
                            <input type="text" name="almt_tetap_kecamatan" class="form-control" value="<?= val($p['kecamatan']) ?>"></div>
                        <div class="col-md-3"><label class="form-label">City :</label>
                            <input type="text" name="almt_tetap_kota" class="form-control" value="<?= val($p['kota']) ?>"></div>
                        <div class="col-md-3"><label class="form-label">Province :</label>
                            <input type="text" name="almt_tetap_provinsi" class="form-control" value="<?= val($p['provinsi'] ?: 'Jawa Timur') ?>"></div>
                        <div class="col-md-3"><label class="form-label">Zip Code :</label>
                            <input type="text" name="almt_tetap_kodepos" class="form-control" maxlength="5" value="<?= val($p['kode_pos']) ?>"></div>
                        <div class="col-md-3"><label class="form-label">Mobile Phone :</label>
                            <input type="text" name="no_hp" class="form-control" value="<?= val($p['no_hp_peg']) ?>"></div>
                    </div>
                </div>
                ...
                <div class="sub-box"><span class="box-title">Temporary Address</span>
                    <div class="row g-3">
                        <div class="col-md-8"><label class="form-label">Address :</label>
                            <textarea name="almt_smtr" class="form-control" rows="2"><?= val($p['alamat_domi_peg'] ?? '') ?></textarea></div>
                        <div class="col-md-2"><label class="form-label">RT :</label>
                            <input type="text" name="almt_smtr_rt" class="form-control" value="<?= val($p['rt_dom'] ?? '') ?>"></div>
                        <div class="col-md-2"><label class="form-label">RW :</label>
                            <input type="text" name="almt_smtr_rw" class="form-control" value="<?= val($p['rw_dom'] ?? '') ?>"></div>
                        <div class="col-md-3"><label class="form-label">Village :</label>
                            <input type="text" name="almt_smtr_desa" class="form-control" value="<?= val($p['kelurahan_dom'] ?? '') ?>"></div>
                        <div class="col-md-3"><label class="form-label">Sub-District :</label>
                            <input type="text" name="almt_smtr_kecamatan" class="form-control" value="<?= val($p['kecamatan_dom'] ?? '') ?>"></div>
                        <div class="col-md-3"><label class="form-label">City :</label>
                            <input type="text" name="almt_smtr_kota" class="form-control" value="<?= val($p['kota_dom'] ?? '') ?>"></div>
                        <div class="col-md-3"><label class="form-label">Province :</label>
                            <input type="text" name="almt_smtr_provinsi" class="form-control" value="<?= val($p['provinsi_dom'] ?? '') ?>"></div>
                        <div class="col-md-3"><label class="form-label">Zip Code :</label>
                            <input type="text" name="almt_smtr_kodepos" class="form-control" maxlength="5" value="<?= val($p['kode_pos_dom'] ?? '') ?>"></div>
                    </div>
                </div>
                ...
                <div class="sub-box"><span class="box-title">Bank</span>
                    <div class="row g-3">
                        <div class="col-md-4"><label class="form-label">Payee :</label>
                            <input type="text" name="bank_payee" class="form-control text-uppercase" value="<?= val($p['bank_payee']) ?>"></div>
                        <div class="col-md-2"><label class="form-label">Kode Bank :</label>
                            <input type="text" name="bank_kode" class="form-control" value="<?= val($p['bank_kode']) ?>"></div>
                        <div class="col-md-3"><label class="form-label">Nama Bank :</label>
                            <input type="text" name="bank_nama" class="form-control" value="<?= val($p['nama_bank']) ?>"></div>
                        <div class="col-md-3"><label class="form-label">Bank Account :</label>
                            <input type="text" name="bank_rekening" class="form-control" value="<?= val($p['no_rekening']) ?>"></div>
                        <div class="col-md-6"><label class="form-label">Bank Detail :</label>
                            <input type="text" name="bank_detail" class="form-control" value="<?= val($p['bank_detail']) ?>"></div>
                    </div>
                </div>
            </fieldset>
...
function kelRow(d){ d=d||{};
    ...
    return `<td><input name="kel_nama[]" class="form-control form-control-sm text-uppercase" value="${esc(d.nama)}"></td>
        ...
        <td><select name="kel_kawin[]" class="form-select form-select-sm">${sel(['SINGLE','MARRIED','DIVORCED','WIDOWED'], d.kawin)}</select></td>
        ...
        <td><input name="kel_ktp[]" class="form-control form-control-sm" maxlength="16" value="${esc(d.ktp)}"></td>
        <td><input name="kel_kk[]" class="form-control form-control-sm" maxlength="16" value="${esc(d.kk)}"></td>
        <td><input name="kel_bpjs[]" class="form-control form-control-sm" value="${esc(d.bpjs)}"></td>
