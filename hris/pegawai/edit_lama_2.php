            ...
            <fieldset>
                <div class="row g-3">
                    <div class="col-md-3"><label class="form-label">Company Name :</label>
                        <input type="text" name="company_name" class="form-control" value="<?= val(g($p,'company_name') ?: 'GRP1') ?>"></div>
                ...
                <div class="sub-box"><span class="box-title">Bank</span>
                    <div class="row g-3">
                        <div class="col-md-4"><label class="form-label">Payee :</label>
                            <input type="text" name="bank_payee" class="form-control text-uppercase" value="<?= val(g($p,'bank_payee')) ?>"></div>
                        <div class="col-md-2"><label class="form-label">Kode Bank :</label>
                            <input type="text" name="bank_kode" class="form-control" value="<?= val(g($p,'bank_kode')) ?>"></div>
                        <div class="col-md-3"><label class="form-label">Nama Bank :</label>
                            <input type="text" name="bank_nama" class="form-control" value="<?= val(g($p,'nama_bank')) ?>"></div>
                        <div class="col-md-3"><label class="form-label">Bank Account :</label>
                            <input type="text" name="bank_rekening" class="form-control" value="<?= val(g($p,'no_rekening')) ?>"></div>
                        <div class="col-md-6"><label class="form-label">Bank Detail :</label>
                            <input type="text" name="bank_detail" class="form-control" value="<?= val(g($p,'bank_detail')) ?>"></div>
                    </div>
                </div>
            </fieldset>
