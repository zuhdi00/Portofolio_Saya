...
try {
    ...
    sqlsrv_free_stmt(q($conn, "DELETE FROM dbo.kontak_darurat WHERE pegawai_id=?", [$id], 'hapus kontak darurat'));
    if (v('darurat_nama') || v('darurat_hubungan') || v('darurat_hp') || v('darurat_alamat')) {
        ...
        sqlsrv_free_stmt(q($conn, $sqlDarurat, [$id, v('darurat_nama'), v('darurat_hubungan'), v('darurat_hp'), v('darurat_alamat')], 'insert kontak darurat'));
    }
