<?php
// Ambil dari file log yang diupdate oleh proxi_mobile.php
$logFile = __DIR__ . '/ip_log.txt';
$defaultIP = '125.167.26.146'; //jika log tidak ditemukan
...
$allowed = [
    ...
    'api_approve_stb.php',
    'api_approve_stb_check.php',
    'api_delete_barcode.php',
    'api_get_item_detail_tbop.php',           // NEW: Get OP from tbOP
