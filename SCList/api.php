    ...
    case 'searchSC':
        ...
        $sql = "
            ...
            CombinedResults AS (
                ...
                SELECT
                    RTRIM(T1.cJnsSc) AS cJnsSc, RTRIM(T1.cNoSC) AS cNoSC, T1.dTanggal, CASE WHEN T1.lTK = 1 THEN 'Tunggu Kabar' ELSE CONVERT(VARCHAR, T1.dTglKirim, 23) END AS dTglKirim, T1.UserDate, 
