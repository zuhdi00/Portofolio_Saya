...
// Allow longer execution for exports
@set_time_limit(6000);
@ini_set('memory_limit', '512M');
// default SQLSRV options used by this script
...
if (!empty($shipFrom))  { $where[] = "sc.dTglKirim2 >= ?";     $params[] = $shipFrom; }
if (!empty($shipTo))    { $where[] = "sc.dTglKirim2 <= ?";     $params[] = $shipTo.' 23:59:59'; }
