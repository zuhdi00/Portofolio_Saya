...
SELECT
    ...
    (ISNULL(stb.total_nqty_stb, 0) - ISNULL(dt.total_dtstock, 0))    AS total_nqty_stb,
    ISNULL(srj.total_nqty_sj,  0)                                     AS total_nqty_sj,
    ISNULL(ret.total_nqty_retur, 0)                                   AS total_nqty_retur,
    (ISNULL(stb.total_nqty_stb, 0) - ISNULL(dt.total_dtstock, 0)) - ISNULL(srj.total_nqty_sj,  0) AS sisa_stb,
    ISNULL(o.order_qty, 0)                                           AS order_qty,
    ISNULL(o.order_qty, 0)                                            AS total_order,
    ISNULL(o.order_qty, 0)
        - (ISNULL(stb.total_nqty_stb, 0) - ISNULL(dt.total_dtstock, 0)) AS sisa_order,
