...
try {
    ...
    $sql = "SELECT 
                op.cnm_c, op.cNoMc, op.cNoOp, op.cnm_brg,
                op.nPanjang, op.nLebar, op.nTinggi, op.nQtyStok, op.nbrutto_usl, op.nbrutto_usp,
                op.nQty, op.dTgl, op.clengkap1, op.clengkap2, op.dTglkirim, op.cpr_ikat, op.clengkap3, op.clengkap4,
                ckd_b1, ckd_b2, ckd_b3, ckd_b4, ckd_b5, cJnsGel, cFlexo, op.cPalet, op.cNoPalet
            FROM tbOP op
            WHERE op.cNoOp = ?";
